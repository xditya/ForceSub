...
print("Starting...")
try:
    apiid = config("5532083", cast=int)
    apihash = config("6f680249ecdaa6bb73223393f44c6023")
    bottoken = config("1775322563:AAFoNcc5Z7A-lPwBhXiHcFmSv48QJKVvrvg")
    xchannel = config("-1001329429624")
    welcome_msg = config("hi shega")
